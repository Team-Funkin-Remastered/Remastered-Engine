...
class DLCMenuState extends MusicBeatState
{
	...
	public static var instance:DLCMenuState;
	...
	override function create()
	{
		...
		noModsTxt = new FlxText(0, 0, FlxG.width, "NO DLC INSTALLED\nDOWNLOAD THE DLC USING THE BOTTOM BUTTON", 48);
	...
	function changeSelection(change:Int = 0)
	{
		...
		for (mod in mods)
		{
			...
			if(i == curSelected)
			{
				...
				// correct layering
				var stuffArray:Array<FlxSprite> = [switchButton, deleteButton, selector, descriptionTxt, mod.alphabet, mod.icon];
